...
var editTask=function(){
    ...
    if(containsClass){
        ...
        label.classList.remove('task__label_edit');
        editInput.classList.remove("task__input_edit");
    }else{
        editInput.value=label.innerText;
        editBtn.innerText="Save";
        label.classList.add('task__label_edit');
...
var taskCompleted=function(){
    ...
    var listItem=this.parentNode;
    listItem.querySelector('.task__label').classList.add('task__label_complited')
...
//Mark task as incomplete.
    ...
    var listItem=this.parentNode;
    listItem.querySelector('.task__label').classList.remove('task__label_complited')
    incompleteTaskHolder.appendChild(listItem);
    bindTaskEvents(listItem,taskCompleted);
}
